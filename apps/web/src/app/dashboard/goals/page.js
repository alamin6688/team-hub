      ...
      >
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Track and manage high-level objectives.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`ml-1 transition-transform ${showFilterMenu ? "rotate-180" : ""}`}
              />
            </button>
              ...
              {showFilterMenu && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 z-[101] overflow-hidden"
                  >
                    <div className="p-1.5">
                      {[
                        "ALL",
      ...
      >
        <table className="w-full text-left text-sm whitespace-nowrap">
          <thead className="bg-gray-50/50 border-b border-gray-200">
            <tr>
              <th className="px-6 py-4 font-semibold text-gray-500 w-[40%]">
                Goal Name
              </th>
              <th className="px-6 py-4 font-semibold text-gray-500 w-[20%]">
                Status
              </th>
              <th className="px-6 py-4 font-semibold text-gray-500 w-[20%]">
                Due Date
              </th>
              <th className="px-6 py-4 font-semibold text-gray-500 w-[10%] text-center">
                Actions
              </th>
            </tr>
          </thead>
            ...
            <AnimatePresence mode="popLayout">
              {filteredGoals.map((goal) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider ${getStatusStyle(goal.status)}`}
                    >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setDeleteModal({ isOpen: true, goalId: goal.id });
                        }}
